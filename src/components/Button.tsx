...
const buttonVariants: Record<ButtonVariant, Record<ButtonColor | 'base', string>> = {
  ...
  default: {
    base: 'border-gray-7 bg-white text-gray-12 shadow-sm hover:border-gray-8 hover:bg-gray-2 active:bg-gray-3 dark:bg-gray-4 dark:hover:bg-gray-5 dark:active:bg-gray-6',
    primary: '',
    gray: '',
    red: '',
    green: '',
  ...
  light: {
    base: 'border-transparent shadow-sm',
    primary: 'bg-primary-4 text-primary-11 hover:bg-primary-5 active:bg-primary-6',
    gray: 'bg-gray-4 text-gray-12 hover:bg-gray-5 active:bg-gray-6',
    red: 'bg-red-4 text-red-11 hover:bg-red-5 active:bg-red-6',
    green: 'bg-green-4 text-green-11 hover:bg-green-5 active:bg-green-6',
    blue: 'bg-blue-4 text-blue-11 hover:bg-blue-5 active:bg-blue-6',
    yellow: 'bg-yellow-4 text-yellow-11 hover:bg-yellow-5 active:bg-yellow-6',
  },
  subtle: {
    base: 'border-transparent',
    primary: 'text-primary-9 hover:bg-primary-4 hover:text-primary-11 active:bg-primary-5',
    gray: 'text-gray-10 hover:bg-gray-4 hover:text-gray-11 active:bg-gray-5',
    red: 'text-red-9 hover:bg-red-4 hover:text-red-11 active:bg-red-5',
    green: 'text-green-9 hover:bg-green-4 hover:text-green-11 active:bg-green-5',
    blue: 'text-blue-9 hover:bg-blue-4 hover:text-blue-11 active:bg-blue-5',
    yellow:
...
const classes = {
  base: 'relative inline-flex select-none items-center justify-center rounded-lg border text-sm font-medium transition-colors',
