import { Button, Dropdown, DropdownItem, Logo, Search, ThemeToggler } from '@/app/components';
import { isActiveLinkNew } from '@/utils/is-active-link';
          ...
          <div className="space-y-1">
            {navigation.map((item) => (
              <Link
                ...
                href={item.href}
                className={clsx(
                  isActiveLinkNew(pathname, item.href)
